...
class WeaponBfg extends Weapon  {
	constructor(g, player) {
		...
		this.itemId = Constants.C_WPN_BFG;
	...
	newBullet(x, y, inertialX, inertialY) {
		return new BulletBfg(this.g, this.player, x, y, inertialX, inertialY);
	}
...
class BulletBfg extends Bullet  {
	...
	constructor(g, player, x, y, inertialX, inertialY) {
		...
		this.texture = g.resources.bullets.textures['tile015.png'];
